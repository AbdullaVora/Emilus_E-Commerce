...
export const protectedRoutes = [
    ...
    {
        key: 'apps.ecommerce.product-variants',
        path: `${APP_PREFIX_PATH}/apps/ecommerce/product-variants`,
        component: React.lazy(() => import('views/app-views/apps/e-commerce/productDeatils')),
    },
    {
        key: 'apps.ecommerce.variants-cartesian',
        path: `${APP_PREFIX_PATH}/apps/ecommerce/variants-cartesian`,
        component: React.lazy(() => import('views/app-views/apps/e-commerce/variants-cartesian')),
    },
    {
